    ...
    <div class="row content">
        <div class="col-sm-3 sidenav hidden-xs">
            ...
            <ul class="nav nav-pills nav-stacked">
                <li><h2><a href="#thread" onclick="navAdmin(1)" id="adm-thread">Thread</a></h2></li>
                <li><h2><a href="#donasi" onClick="navAdmin(2)" id="adm-donasi">Donasi</a></h2></li>
                <li><h2><a href="logout" id="adm-logout">LogOut</a></h2></li>
            </ul><br>
        </div>
        <br>
